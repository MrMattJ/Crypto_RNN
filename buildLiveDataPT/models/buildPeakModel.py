...
def buildPeakModel(LSTM_UNITS, DENSE_UNITS, OPTIMIZER, LEARNING_RATE, BATCH_SIZE, EPOCHS, VALIDATION_SPLIT):
    print("Starting model training...")

    # Loading the training data
    X_train = np.load('buildLiveDataPT/Data/training/X_train_peaks.npy')
    y_train = np.load('buildLiveDataPT/Data/training/y_train_peaks.npy')
    ...
    model.save('buildLiveDataPT/Results/lstm_peak_prediction_model.h5')

    # Load the testing data
    X_test = np.load('buildLiveDataPT/data/testing/X_test_peaks.npy')
    y_test = np.load('buildLiveDataPT/data/testing/y_test_peaks.npy')
    ...
    print("Peak model training completed and model saved.")
